...
$(document).ready(function(){
    $("#input_{{cell.execution_count}}").hide();               <!-- Code is hidden by default -->
    $("#button_{{cell.execution_count}}").click(function(){
        $("#input_{{cell.execution_count}}").toggle();
    });
});
</script>
<div class="input" id="input_{{cell.execution_count}}">
{{ super() }}
</div>
{%- endif -%}
...
{%- endif -%}
{%- if cell.execution_count is defined -%}
<button class="code-btn" id="button_{{cell.execution_count}}"><i class="fa fa-code" style="font-size:1em; color:black"></i></button>
{%- endif -%}
    </div>
