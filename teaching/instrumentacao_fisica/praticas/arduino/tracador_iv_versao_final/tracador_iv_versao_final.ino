...
int T = 235;      // Substituir o valor de T em ms
float Rs = 221.4; // Resistência (em Ohms) do resistor sensor de corrente
float numMedias=100.0;
int medida_atual = 1;
